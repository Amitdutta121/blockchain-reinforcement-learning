...
class BlockchainCustomEnvWithCustomDataset(gym.Env):
    def __init__(self, transaction_coefficient, waiting_time_coefficient, pending_transaction_coefficient,
                 transactions_data):
        super(BlockchainCustomEnvWithCustomDataset, self).__init__()
    ...
    def step(self, action):
        ...
        try:
            transaction_size = self.transactions_data.iloc[[self.current_frame]]["transaction_size"].values[0]
            transaction_data = self.transactions_data.iloc[[self.current_frame]]["transaction_data"].values[0]
        except:
            transaction_size = 0
            transaction_data = 0
        ...
        waiting_time_while_creating_block = 0
        ...
        if action == 0:
            ...
            waiting_time_while_creating_block = waiting_time
        ...
        return observation, reward, done, {waiting_time_while_creating_block}
